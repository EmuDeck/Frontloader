...
FocusScope {
    ...
    readonly property list<SettingsEntry> optionList: [
        ...
        SettingsEntry {
            ...
            boolSetter: (val) => {
                return Internal.settings.fullscreen = val;
            }
            section: "general"
        },
        SettingsEntry {
            label: QT_TR_NOOP("Autoboot")
            type: SettingsEntry.Type.Bool
            boolValue: Internal.settings.autoboot
            boolSetter: (val) => {
                return Internal.settings.autoboot = val;
            }
            section: "general"
        },
        SettingsEntry {
            label: QT_TR_NOOP("Autoboot game")
            type: SettingsEntry.Type.Select
            selectBox: autobootBox
        ...
        SettingsEntry {
            ...
            boolSetter: (val) => {
                return Internal.settings.mouseSupport = val;
            }
            section: "controls"
        },
        SettingsEntry {
        ...
        SettingsEntry {
            ...
            boolSetter: (val) => {
                return Internal.settings.verifyFiles = val;
            }
            section: "gaming"
        },
        SettingsEntry {
    ...
    Component {
        ...
        SectionTitle {
            ...
            case "general":
                return QT_TR_NOOP("General");
            case "controls":
                return QT_TR_NOOP("Controls");
            case "gaming":
                return QT_TR_NOOP("Gaming");
            }
    ...
    MultivalueBox {
        ...
        z: 3
        model: Internal.settings.autobootGames
        index: Internal.settings.autobootGames.currentIndex
        onClose: options.focus = true
        onSelect: {
            Internal.settings.autobootGames.currentIndex = index;
            Internal.settings.autobootGame = model.name;
        }
    }
