...
namespace model
{
	...
	GamepadManagerSDL2::GamepadManagerSDL2(QObject* parent)
			: GamepadManagerBackend(parent), m_sdl_version(linked_sdl_version())
	{
	...
	std::string
	GamepadManagerSDL2::generate_mapping_for_field(const char* const field, const char* const recording_field,
